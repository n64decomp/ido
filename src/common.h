...
#define GETBIT32(value, index) ((unsigned int)(index) < 32U && ((value) & (1U << (31 - (index)))))
...
#define SET64_INIT(set, value) (set) = (1ll << ((~(value)) & 0x3f));
#define SET64_ADD(set, value) (set) |= ((unsigned long long)((value) < 64U) << ((~(value)) & 0x3f))
